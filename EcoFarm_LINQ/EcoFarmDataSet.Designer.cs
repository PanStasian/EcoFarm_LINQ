...
namespace EcoFarm_LINQ.EcoFarmDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([Employee_Number] = @Original_Employee_Number) AND ([Full_Name] = @Original_Full_Name) AND ([Phone_Number] = @Original_Phone_Number) AND ([Adress] = @Original_Adress) AND ([Position_Code] = @Original_Position_Code) AND ([Passport_Number] = @Original_Passport_Number) AND ([Passport_Series] = @Original_Passport_Series) AND ([Birth_Date] = @Original_Birth_Date))";
...
SELECT Employee_Number, Full_Name, Phone_Number, Adress, Position_Code, Passport_Number, Passport_Series, Birth_Date FROM Employees WHERE (Employee_Number = @Employee_Number)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Employee_Number] = @Employee_Number, [Full_Name] = @Full_Name, [Phone_Number] = @Phone_Number, [Adress] = @Adress, [Position_Code] = @Position_Code, [Passport_Number] = @Passport_Number, [Passport_Series] = @Passport_Series, [Birth_Date] = @Birth_Date WHERE (([Employee_Number] = @Original_Employee_Number) AND ([Full_Name] = @Original_Full_Name) AND ([Phone_Number] = @Original_Phone_Number) AND ([Adress] = @Original_Adress) AND ([Position_Code] = @Original_Position_Code) AND ([Passport_Number] = @Original_Passport_Number) AND ([Passport_Series] = @Original_Passport_Series) AND ([Birth_Date] = @Original_Birth_Date));
SELECT Employee_Number, Full_Name, Phone_Number, Adress, Position_Code, Passport_Number, Passport_Series, Birth_Date FROM Employees WHERE (Employee_Number = @Employee_Number)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EcoFarm_LINQ.Properties.Settings.Default.EcoFarmConnectionString1;
        }
    ...
    public partial class PositionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Position] WHERE (([Position_Code] = @Original_Position_Code) A" +
                ...
                "nt_Code) AND ([Activity] = @Original_Activity))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Position_Code", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Position_Code", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT Position_Code, Position, Department_Code, Activity FROM Position WHERE (Position_Code = @Position_Code)";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Position] SET [Position_Code] = @Position_Code, [Position] = @Position, [Department_Code] = @Department_Code, [Activity] = @Activity WHERE (([Position_Code] = @Original_Position_Code) AND ([Position] = @Original_Position) AND ([Department_Code] = @Original_Department_Code) AND ([Activity] = @Original_Activity));
SELECT Position_Code, Position, Department_Code, Activity FROM Position WHERE (Position_Code = @Position_Code)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Position_Code", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Position_Code", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
